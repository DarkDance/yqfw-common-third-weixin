...
public class WxPayCbHelper {
    ...
    private void verifyHeader(WxPayAuth wxPayAuth, Map<String, String> returnHeaderMap, String returnParam) throws SSLException {
        ...
        try {
            ...
            boolean matchResult = DigestUtilPlus.RSA.verifyWithSHA256(waitSign.getBytes(StringUtilPlus.UTF_8), DigestUtilPlus.Base64.decodeBase64(weixinSign), DigestUtilPlus.Base64.decodeBase64(plantCertRedisDto.getPublicKey()));
            if (!matchResult) {
