...
public enum WxMpIndustryEnum {
    ...
    public static WxMpIndustryEnum valueOf(String firstClass, String secondClass) {
        return Arrays.stream(WxMpIndustryEnum.values())
                .filter(industryEnum -> industryEnum.firstClass.equals(firstClass) && industryEnum.secondClass.contains(secondClass))
                .findFirst().orElse(null);
    }

    public static WxMpIndustryEnum valueOf(int code) {
        return Arrays.stream(WxMpIndustryEnum.values())
