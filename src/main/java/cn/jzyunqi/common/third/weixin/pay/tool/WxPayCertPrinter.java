...
public class WxPayCertPrinter {
    ...
    public static void printCert(String certPath) throws Exception {
        ...
        boolean rst = DigestUtilPlus.RSA.verifyWithSHA256(waitSign.getBytes(StringUtilPlus.UTF_8), DigestUtilPlus.Base64.decodeBase64(signature), DigestUtilPlus.Base64.decodeBase64(weixinServerPublicKeyStr));
