...
public interface WxMpSubscribeMsgApiProxy {
    ...
    WxMpTemplateData privateTemplateAdd(@RequestParam String access_token, @RequestBody WxMpTemplateParam request) throws BusinessException;
    ...
    WeixinRspV2<List<WxMpPubTemplateKeywordData>> publicTemplateKeywordsList(@RequestParam String access_token, @RequestBody WxMpTemplateParam request) throws BusinessException;
    ...
    WeixinRspV2<List<WxMpTemplateData>> privateTemplateList(@RequestParam String access_token) throws BusinessException;
